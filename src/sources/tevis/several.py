...
class Bremen(TevisBaseScraper):
    ID = "bremen"
    NAME = "Stadt Bremen / Bremerhaven"
    BASE_URL = "https://termin.bremen.de/termine"
...
class Goettingen(TevisBaseScraper):
    ID = "goettingen"
    NAME = "Stadt Göttingen"
    BASE_URL = "https://termin.goettingen.de"
